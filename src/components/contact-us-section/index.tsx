...
export const ContactUsSection = (props) => {
  ...
  const {reset, register, handleSubmit, formState: {errors}} = useForm<ContactUsRequestBody>({
    defaultValues
  });

  const {isLoading, mutate} = useMutation<AxiosResponse<{ msg: string }>, AxiosError<{ msg: string }>, ContactUsRequestBody>({
          ...
          <div className="col-lg-8 pe-lg-5">
            ...
            <form id="contact-form" className="contact-form" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="d-grid">
                <button type="submit" value="submit" className="btn btn-dark btn-primary-hover rounded-0" name="submit">Submit</button>
