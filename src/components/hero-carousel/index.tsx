    ...
    <div className="slider_area slick_slider_activation" data-slick='{
      ...
      <Carousel
        ...
        renderArrowPrev={(clickHandler) => {
          return <button className="slick-button prev_arrow slick-arrow" onClick={clickHandler}><i className="icon-arrow-left icons" /></button>
        }}
        renderArrowNext={(clickHandler) => {
          return <button className="slick-button next_arrow slick-arrow" onClick={clickHandler}><i className="icon-arrow-right icons" /></button>
        }}
      >
      <div className="single_slider d-flex align-items-center" style={{background: 'url("/assets/img/slider/slider1.jpg")'}}>
      ...
      <div className="single_slider d-flex align-items-center" style={{background: 'url("/assets/img/slider/slider2.jpg")'}}>
        <div className="container">
          <div className="row">
            <div className="col-lg-6 col-md-7">
