...
export const ProductListing = (props: ProductListingProps) => {
  ...
  if (isLoading) {
    return <>{[...Array.from({length: pageLimit}, (_, i) => i)]?.map(index => {
      return <div key={index} className={isGrid ? 'col-lg-4 col-md-4 col-sm-6' : 'col-12 d-flex'} style={{textAlign: 'center'}}>
