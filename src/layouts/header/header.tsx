                ...
                <div className="header_container d-flex justify-content-between align-items-center">
                  <div className="header_logo cursor-pointer">
                    <a className="sticky_none ">
                      <Link className="cursor-pointer" href="/home"><img src="/assets/img/logo/logo.png" alt=""/></Link>
                    </a>
                  </div>
                  <div className="main_menu d-none d-lg-block">
                    <nav className="position-relative">
                      <ul className="d-flex">
                        ...
                        <li className="megamenu-holder"><Link href="/shop">shop</Link>
                        ...
                        <li><Link href="/contact" className='link'><a>Contact</a>
                        </Link></li>
                      </ul>
                    </nav>
                  </div>
                      ...
                      <ul className="d-flex">
                        ...
                        <li className="account_link"><a href="#"><i className="icon-user icons"/></a>
                          <ul className="dropdown_account_link">
                            ...
                            <li><Link href="/contact"><a>Contact</a>
                            </Link></li>
                          </ul>
                        </li>
