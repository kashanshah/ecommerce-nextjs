...
import {SkeletonPagination} from "../../components/skeleton/skeleton-pagination";
import {Pagination} from "../../components/pagination";

export const ShopScreen = () => {

  const {query, query: {page = 1}} = useRouter();
  ...
  const {isLoading, mutate, data} = useMutation<{ data: any[]; total: number; offset: number; limit: number; }, AxiosError, { limit?: number; offset?: number }>({
